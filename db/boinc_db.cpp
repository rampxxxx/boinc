...
void USER_WORKUNIT::clear() {memset(this, 0, sizeof(*this));}
...
DB_USER_WORKUNIT::DB_USER_WORKUNIT(DB_CONN* dc) :
    DB_BASE("user_workunit", dc?dc:&boinc_db){}
...
void DB_USER_WORKUNIT::db_parse(MYSQL_ROW &r) {
    int i=0;
    clear();
    user_id = atoi(r[i++]);
